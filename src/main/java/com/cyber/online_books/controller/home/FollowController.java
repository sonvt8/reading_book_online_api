...
public class FollowController extends ExceptionHandling {
    ...
    @GetMapping(value = "/theo-doi-truyen")
    ...
    @DeleteMapping(value = "/huy-theo-doi/{storyId}/{userId}")
    public ResponseEntity< HttpResponse > deletePayDraw(@PathVariable("storyId") Long storyId, @PathVariable("userId") Long userId,
