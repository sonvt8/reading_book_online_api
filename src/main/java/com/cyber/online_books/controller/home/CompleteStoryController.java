...
public class CompleteStoryController {
    ...
    @Autowired
    public CompleteStoryController(StoryService storyService) {
        this.storyService = storyService;
    }

    @GetMapping(value = "")
    public ResponseEntity<CatalogResponse> getCompleteStory(@RequestParam(name="pagenumber") Integer pagenumber) {
        ...
        Page< StoryUpdate > completeStoryPage = storyService.findStoryUpdateByStatus(ConstantsListUtils.LIST_CHAPTER_DISPLAY,
        ...
        catalogResponse.setListStoryPage(completeStoryPage);
